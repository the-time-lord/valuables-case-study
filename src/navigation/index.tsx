...
import { ValuableContext } from '../context/ValuableContext';
import { useState } from 'react';
import { Valuable } from '../types/Valuable';
import { valuablesList } from './valuablesList';

export default function Navigation() {
  const [valuables, setValuables] = useState<Valuable[]>(valuablesList);

  return (
    <NavigationContainer theme={DefaultTheme}>
      <ValuableContext.Provider value={{ valuables, setValuables }}>
        <RootNavigator />
